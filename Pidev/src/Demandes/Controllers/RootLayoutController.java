...
public class RootLayoutController implements Initializable {
    ...
    public void handleRetrieveView() {
      ...
      //afficher le retrieve view
        try {            
            ...
            loader.setLocation(Main.class.getResource("/Demandes/Views/RetrieveForm.fxml"));
    ...
    public void handleCreateView() {
        ...
        try {
            //load CreationView
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("/Demandes/Views/CreationForm.fxml"));
            myView = (AnchorPane) loader.load();
            //affecter la vue dans le root border pane
            rootBorderPane.setCenter(myView);
    ...
    public void handleUpdateView() {
     ...
     //afficher le update view
        try {
            //load UpdateView
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("/Demandes/Views/UpdateForm.fxml"));
            myView = (AnchorPane) loader.load();
            //affecter la vue dans le root border pane
            rootBorderPane.setCenter(myView);
        }catch (IOException e) {
    ...
    //afficher le delete view
        try {
            //load DeleteView
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("/Demandes/Views/DeleteForm.fxml"));
            myView = (AnchorPane) loader.load();
            //affecter la vue dans le root border pane
            rootBorderPane.setCenter(myView);
        }catch (IOException e) {
    ...
    public void handleHelp(ActionEvent actionEvent) {
        ...
        alert.setHeaderText("Bonjour Responsable !");
        alert.setContentText("Vous pouvez consulter, chercher, ajouter, modifier, et supprimer des demandes.");
        alert.show();
    }
