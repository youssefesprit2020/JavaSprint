...
public class DeleteFormController implements Initializable {
    ...
    try
        {
        //recuperer la liste des affectations dans un ObservableArrayList 
        dao =new DAO();
    ...
    @FXML
    public void handleDeleteAffectation (ActionEvent actionEvent)
    {
        try
        { 
            ...
            dao = new DAO();
            dao.deleteAffectation(retrieveTableView.getSelectionModel().getSelectedItem().getId());
            ...
            alert.setContentText("Affectation supprimé");
            alert.show();
            }
            else{
                //un msg d erreur
