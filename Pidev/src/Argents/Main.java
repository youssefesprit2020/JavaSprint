...
import Argents.Controllers.RootLayoutController;
...
public class Main extends Application {
    ...
    //initialiser le root layout
    public void initRootLayout() {
        try {
            //appler le fichier root view file
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(Main.class.getResource("/Argents/Views/RootLayout.fxml"));
